...
import { Box, Typography, Container, Button, ButtonBase, Grid, AppBar, Toolbar, Paper } from '@mui/material';
            ...
            <Grid item xs={12} sm={6}>
              <Paper elevation={3} style={{ padding: '1rem' }}>
                ...
                <Typography variant="body2">
                  View and manage the staff involved in the pharmacy operations.
                </Typography>
              </Paper>
            </Grid>
            <Grid item xs={12} sm={6}>
            <ButtonBase onClick={() => navigate('/Inventory')} style={{ width: '100%' }}>
                <Paper elevation={3} style={{ padding: '1rem', width: '100%' }}>
                  <Typography variant="h6">Manage Inventory</Typography>
                  <Typography variant="body2">
                    Keep track of your medication stock and update inventory as needed.
                  </Typography>
                </Paper>
              </ButtonBase>
            </Grid>
